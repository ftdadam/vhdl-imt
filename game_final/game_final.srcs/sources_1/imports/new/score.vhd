...
port (  enb : in STD_LOGIC;
        ...
        o_h_score : out STD_LOGIC_VECTOR (NB_COUNTER - 1 downto 0)
);
end entity score;

architecture Behavioral of score is
    signal score : unsigned(NB_COUNTER-1 downto 0);
    signal high_score : unsigned (NB_COUNTER-1 downto 0);
    signal tick_gen_max : integer;
begin

process (clk, rst, rst_game) is
begin
    if(rst = '1') then
        score <= (others => '0');
        high_score <= (others => '0');
...
o_h_score <= std_logic_vector(high_score);
