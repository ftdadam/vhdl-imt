    ...
    signal tick_gen_max_player : STD_LOGIC_VECTOR (25 downto 0);
    ...
    signal connect_enb_display : STD_LOGIC_VECTOR (3 downto 0);
    
    begin
    
    enb <= not(connect_game_over) and SW(1); 
    tick_gen_max_display <= std_logic_vector(to_unsigned(100000,tick_gen_max_display'length));
    tick_gen_max_player <= std_logic_vector(to_unsigned(1562500,tick_gen_max_display'length));
    ...
    u_player_tick_gen : tick_gen
    port map (  enb => enb,
                rst => SW(0),
                clk => pixel_clk,
                i_tick_gen_max => tick_gen_max_player,
